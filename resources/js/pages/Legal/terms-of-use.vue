<template>
  <app-layout>
    <div class="brand-container brand-container--lg">
      ...
      <p>
        The Stakenet DEX bug reports website located at
        https://dex-bug-reports.stakenet.info/ is a copyrighted work belonging
        to Stakenet community. Certain features of the Site may be subject to
      ...
      <p>
        ...
        Stakenet DEX bug reports uses ‘cookies’. These cookies are used to store
      ...
      <p>
        ...
        the Company should be sent to: Europe. After the Notice is received, you
